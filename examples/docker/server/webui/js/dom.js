export const elements = {
  ...
  genPanel: document.querySelector("#gen-panel"),
  genForm: document.querySelector("#gen-form"),
  genFamilyFields: document.querySelector("#gen-family-fields"),
  genResult: document.querySelector("#gen-result"),
  genAudio: document.querySelector("#gen-audio"),
  genDownload: document.querySelector("#gen-download"),
  genMetrics: document.querySelector("#gen-metrics"),
